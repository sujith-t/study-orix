...
public abstract class RestConnector {
     ...
     */    
    private HttpResponse call(String path, String method, Map<String, String> headers, byte[] content) throws MalformedURLException, IOException, NoSuchAlgorithmException, KeyManagementException {
